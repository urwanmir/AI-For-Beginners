...
To see how we can use perceptron to solve a toy problem as well as real-life problems, and to continue learning - go to [Perceptron](/notebooks/Perceptron.ipynb) notebook.
...
* [Notebook](/notebooks/lab/PerceptronMultiClass.ipynb)