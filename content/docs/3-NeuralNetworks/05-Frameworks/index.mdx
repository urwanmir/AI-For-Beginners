...
> âœ… The term 'parallelize' means to distribute the computations over multiple devices.
...
## âœï¸ Exercises: Frameworks

Continue your learning in the following notebooks:

Low-Level API | [TensorFlow+Keras Notebook](/notebooks/IntroKerasTF.ipynb) | [PyTorch](/notebooks/IntroPyTorch.ipynb)
--------------|-------------------------------------|--------------------------------
High-level API| [Keras](/notebooks/IntroKeras.ipynb) | *PyTorch Lightning*
...
* [Notebook](/notebooks/lab/LabFrameworks.ipynb)