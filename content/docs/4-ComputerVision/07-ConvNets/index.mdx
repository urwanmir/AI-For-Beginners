...
![Vertical Edge Filter](../../assets/images/4-ComputerVision/07-ConvNets/images/filter-vert.png) | ![Horizontal Edge Filter](../../assets/images/4-ComputerVision/07-ConvNets/images/filter-horiz.png)
----|----
...
![Hierarchical Feature Extraction](../../assets/images/4-ComputerVision/07-ConvNets/images/FeatureExtractionCNN.png)
...
## âœï¸ Exercises: Convolutional Neural Networks
...
* [Convolutional Neural Networks - PyTorch](/notebooks/ConvNetsPyTorch.ipynb)
* [Convolutional Neural Networks - TensorFlow](/notebooks/ConvNetsTF.ipynb)
