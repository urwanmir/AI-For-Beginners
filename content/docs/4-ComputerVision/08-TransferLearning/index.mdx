...
> âœ… Transfer Learning is a term you find in other academic fields, such as Education. It refers to the process of taking knowledge from one domain and applying it to another.
...
![Features extracted by VGG-16](../../assets/images/4-ComputerVision/08-TransferLearning/images/features.png)
...
## âœï¸ Exercise: Transfer Learning

Let's see transfer learning in action in corresponding notebooks:

* [Transfer Learning - PyTorch](/notebooks/TransferLearningPyTorch.ipynb)
* [Transfer Learning - TensorFlow](/notebooks/TransferLearningTF.ipynb)
...
![Image Optimization Loop](../../assets/images/4-ComputerVision/08-TransferLearning/images/ideal-cat-loop.png)
...
![Ideal Cat](../../assets/images/4-ComputerVision/08-TransferLearning/images/ideal-cat.png) | ![Ideal Zebra](../../assets/images/4-ComputerVision/08-TransferLearning/images/ideal-zebra.png)
-----|-----
...
![Picture of a Dog](../../assets/images/4-ComputerVision/08-TransferLearning/images/original-dog.png) | ![Picture of a dog classified as a cat](../../assets/images/4-ComputerVision/08-TransferLearning/images/adversarial-dog.png)
-----|-----
...
* [Ideal and Adversarial Cat - TensorFlow](/notebooks/AdversarialCat_TF.ipynb)
## Conclusion
