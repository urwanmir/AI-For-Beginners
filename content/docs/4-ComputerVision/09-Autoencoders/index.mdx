...
Since we are training an autoencoder to capture as much of the information from the original image as possible for accurate reconstruction, the network tries to find the best **embedding** of input images to capture the meaning.Ð».

![AutoEncoder Diagram](../../assets/images/4-ComputerVision/09-Autoencoders/images/autoencoder_schema.jpg)
...
## âœï¸ Exercises: Autoencoders

Learn more about autoencoders in these corresponding notebooks:

* [Autoencoders in TensorFlow](/notebooks/AutoencodersTF.ipynb)
* [Autoencoders in PyTorch](/notebooks/AutoEncodersPyTorch.ipynb)
...
At the end of [this notebook using TensorFlow](/notebooks/AutoencodersTF.ipynb), you will find a 'task' - use this as your assignment.