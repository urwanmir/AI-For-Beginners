...
You can also use OpenCV to load video frame-by-frame - an example is given in the exercise [OpenCV Notebook](/notebooks/OpenCV.ipynb).
...
In our [OpenCV Notebook](/notebooks/OpenCV.ipynb), we give some examples of when computer vision can be used to perform specific tasks:
...
![Braille Image](../../assets/images/4-ComputerVision/06-IntroCV/data/braille.jpeg) | ![Braille Image Pre-processed](../../assets/images/4-ComputerVision/06-IntroCV/images/braille-result.png) | ![Braille Symbols](../../assets/images/4-ComputerVision/06-IntroCV/images/braille-symbols.png)
----|-----|-----

> Image from [OpenCV.ipynb](/notebooks/OpenCV.ipynb)
...
![Image of video frames and frame differences](../../assets/images/4-ComputerVision/06-IntroCV/images/frame-difference.png)
...
![Image of Optical Flow](../../assets/images/4-ComputerVision/06-IntroCV/images/optical.png)

> Image from [OpenCV.ipynb](/notebooks/OpenCV.ipynb)

## âœï¸ Example Notebooks: OpenCV [try OpenCV in Action](/notebooks/OpenCV.ipynb)

Let's do some experiments with OpenCV by exploring [OpenCV Notebook](/notebooks/OpenCV.ipynb)
