...
![Summary of Symbolic AI content](../assets/images/sketchnotes/ai-symbolic.png)
...
> âœ… **Knowledge** is something which is contained in our head and represents our understanding of the world. It is obtained by an active **learning** process, which integrates pieces of information that we receive into our active model of the world.
...
![Knowledge representation spectrum](../assets/images/2-Symbolic/images/knowledge-spectrum.png)
...
> âœ… Think for a minute about how you represent knowledge in your head and convert it to notes. Is there a particular format that works well for you to aid in retention?
...
> âœ… Think how triplets can be used to represent other types of knowledge.
...
![Human Architecture](../assets/images/2-Symbolic/images/arch-human.png) | ![Knowledge-Based System](../assets/images/2-Symbolic/images/arch-kbs.png)
---------------------------------------------|------------------------------------------------
...
![AND-OR Tree](../assets/images/2-Symbolic/images/AND-OR-Tree.png)
...
> âœ… Write your own AND-OR tree on a topic you like!
...
> âœ… In which situations is forward inference more appropriate? How about backward inference?
...
## âœï¸ Exercise: Animal Inference

See [Animals.ipynb](/notebooks/https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/2-Symbolic/Animals.ipynb) for an example of implementing forward and backward inference expert system.
...
## âœï¸ Exercise: A Family Ontology
...
## âœï¸ Exercise: A Concept Graph

Try the [MSConceptGraph.ipynb](/notebooks/https://github.com/microsoft/AI-For-Beginners/blob/main/lessons/2-Symbolic/MSConceptGraph.ipynb) notebook to see how we can use Microsoft Concept Graph to group news articles into several categories.
