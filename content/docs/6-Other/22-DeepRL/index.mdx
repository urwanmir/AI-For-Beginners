...
> Learn more about the Policy Gradient algorithm and see it in action in the [example notebook](/notebooks/CartPole-RL-TF.ipynb).
...
## âœï¸ Exercises: Policy Gradients and Actor-Critic RL

Continue your learning in the following notebooks:

* [RL in TensorFlow](/notebooks/CartPole-RL-TF.ipynb)
* [RL in PyTorch](/notebooks/CartPole-RL-PyTorch.ipynb)
