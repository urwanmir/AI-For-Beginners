...
## âœï¸ Exercises: Genetic Algorithms

Continue your learning in the following notebooks:

Go to [this notebook](/notebooks/Genetic.ipynb) to see two examples of using Genetic Algorithms:
...
## [Assignment: Diophantine Equation](/notebooks/Diophantine.ipynb)
...
Use [Diophantine.ipynb](/notebooks/Diophantine.ipynb) as a starting point.