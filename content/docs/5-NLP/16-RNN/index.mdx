...
![RNN Cell Anatomy](../../assets/images/5-NLP/16-RNN/images/rnn-anatomy.png)
...
![Image showing an example long short term memory cell](../../assets/images/5-NLP/16-RNN/images/long-short-term-memory-cell.svg)
...
![Image showing a Multilayer long-short-term-memory- RNN](../../assets/images/5-NLP/16-RNN/images/multi-layer-lstm.jpg)
...
## âœï¸ Exercises: Embeddings

Continue your learning in the following notebooks:

* [RNNs with PyTorch](/notebooks/RNNPyTorch.ipynb)
* [RNNs with TensorFlow](/notebooks/RNNTF.ipynb)
