...
![Image showing diagram mapping a character to an ASCII and binary representation](../../assets/images/5-NLP/13-TextRep/images/ascii-character-map.png)
...
## âœï¸ Exercises: Text Representation

Continue your learning in the following notebooks:

* [Text Representation with PyTorch](/notebooks/TextRepresentationPyTorch.ipynb)
* [Text Representation with TensorFlow](/notebooks/TextRepresentationTF.ipynb)
