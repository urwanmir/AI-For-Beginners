...
![Image showing an embedding classifier for five sequence words.](../../assets/images/5-NLP/14-Embeddings/images/embedding-classifier-example.png)
...
* [Embeddings with PyTorch](/notebooks/EmbeddingsPyTorch.ipynb)
* [Embeddings TensorFlow](/notebooks/EmbeddingsTF.ipynb)
...
![Image showing both CBoW and Skip-Gram algorithms to convert words to vectors.](../../assets/images/5-NLP/14-Embeddings/images/example-algorithms-for-converting-words-to-vectors.png)
