---
title: "Training Skip-Gram Model"
...
In this lab, you we challenge you to train Word2Vec model using Skip-Gram technique. Train a network with embedding to predict neighboring words in $N$-tokens-wide Skip-Gram window. You can use the [code from this lesson](/notebooks/../CBoW-TF.ipynb), and slightly modify it.
