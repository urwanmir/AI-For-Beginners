...
![image from paper on converting words to vectors](../../assets/images/5-NLP/14-Embeddings/images/example-algorithms-for-converting-words-to-vectors.png)

> Image from [this paper](https://arxiv.org/pdf/1301.3781.pdf)

## âœï¸ Example Notebooks: Training CBoW model

Continue your learning in the following notebooks:

* [Training CBoW Word2Vec with TensorFlow](/notebooks/CBoW-TF.ipynb)
* [Training CBoW Word2Vec with PyTorch](/notebooks/CBoW-PyTorch.ipynb)
...
## ðŸš€ [Assignment: Train Skip-Gram Model](lab/README.md)
