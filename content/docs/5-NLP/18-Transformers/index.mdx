...
![Image showing an encoder/decoder model with an additive attention layer](../../assets/images/5-NLP/18-Transformers/images/encoder-decoder-attention.png)
...
![Image showing a sample alignment found by RNNsearch-50, taken from Bahdanau - arviz.org](../../assets/images/5-NLP/18-Transformers/images/bahdanau-fig3.png)
...
[TensorFlow Notebook](/notebooks/TransformersTF.ipynb) contains more detains on the implementation of transformer layers.
...
![picture from http://jalammar.github.io/illustrated-bert/](../../assets/images/5-NLP/18-Transformers/images/jalammarBERT-language-modeling-masked-lm.png)

> Image [source](http://jalammar.github.io/illustrated-bert/)

## âœï¸ Exercises: Transformers

Continue your learning in the following notebooks:

* [Transformers in PyTorch](/notebooks/TransformersPyTorch.ipynb)
* [Transformers in TensorFlow](/notebooks/TransformersTF.ipynb)
